...
class _PositionsDatasource implements PositionsDatasource {
  ...
  @override
  Future<ProfileDto> createPosition(CreateUserParams params) async {
  ...
  @override
  Future<ProfileDto> updatePosition(
    dynamic id,
  ...
  @override
  Future<List<ProfileDto>> fetchPositions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ProfileDto> deletePosition(dynamic id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
