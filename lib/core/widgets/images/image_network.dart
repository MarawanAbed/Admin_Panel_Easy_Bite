...
class ImageNetwork extends StatelessWidget {
  ...
  const ImageNetwork({super.key, this.url, this.width, this.height, this.fit, this.color, this.size, this.borderRadius, this.margin, this.padding, this.radius});

  @override
  Widget build(BuildContext context) {
    print('ImageNetwork $url');
    return Container(
      height: size ?? height,
      width: size ?? width,
