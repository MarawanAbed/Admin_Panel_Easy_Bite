...
import 'package:admin/core/di/injector.dart';

class ResponsiveService {
  static const Size _designSize = Size(958, 1872);
  ...
  static Size _switchableDesignSize() {
    return _mediaQueryData.orientation == Orientation.portrait ? _designSize : const Size(1872, 958);
  }
  ...
  static double scaleHeight() =>
      (_splitScreenMode ? max(availableScreenHeight(), 1872) : availableScreenHeight()) / _switchableDesignSize().height;
