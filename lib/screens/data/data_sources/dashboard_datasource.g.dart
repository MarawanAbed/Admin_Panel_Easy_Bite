...
class _DashboardDatasource implements DashboardDatasource {
  ...
  @override
  Future<OrderStatistics> ordersStatistics() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<OrderStatistics>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = OrderStatistics.fromJson(_result.data!);
    return value;
  }

  @override
  Future<List<OrderDto>> fetchEmployees() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
